...
public class ListDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean mIsDrawFirstLine = false;
    ...
    public void drawFirstLine(boolean isDrawFirstLine) {
        mIsDrawFirstLine = isDrawFirstLine;
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = startPosition; i < childCount; i++) {
            ...
            final int top;
            if(mIsDrawFirstLine && i == startPosition){
                top = child.getTop() + mDividerHeight;
            } else {
                top = child.getTop();
            }

            final int bottom = child.getBottom() + mDividerHeight;
