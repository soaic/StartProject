package com.soaic.libcommon.weight.recyclerview.weight;
...
import com.soaic.libcommon.weight.recyclerview.adapter.BasicSlidingAdapter;
...
public class SlidingMenu extends HorizontalScrollView {
     ...
     * 获取 adapter
     */
    private BasicSlidingAdapter getAdapter() {
        View view = this;
        while (true) {
        ...
        return (BasicSlidingAdapter) ((RecyclerView) view).getAdapter();
    }
