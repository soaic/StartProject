...
package com.soaic.libcommon.weight.badgeView;
...
public class BadgeView extends AppCompatTextView {
    ...
    private void init(AttributeSet attrs) {
        if (!(getLayoutParams() instanceof LayoutParams)) {
            LayoutParams layoutParams =
                    new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.RIGHT | Gravity.TOP);
        ...
        int fillColor = Color.parseColor("#d3321b");
        int strokeColor = Color.parseColor("#d3321b");

        // set default background
        setBackground(9, fillColor, strokeColor);
    ...
    public void setBackground(int dipRadius, int fillColor, int strokeColor) {
        int radius = dip2Px(dipRadius);
        int strokeWidth = dip2Px(0.5f);
